...
> **Fee Notice (2026-02-28):** Fee math in this document (1% trading, 10% settlement, 11% hurdle) is SUPERSEDED. Actual: taker fee = max(ceil(0.07*C*P*(1-P)), C*$0.01). No settlement fee. Real hurdle ~1-2%.
